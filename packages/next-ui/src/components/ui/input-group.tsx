...
function InputGroupAddon({
	...
	return (
		// biome-ignore lint/a11y/noNoninteractiveElementInteractions: this is a custom component
		// biome-ignore lint/a11y/noStaticElementInteractions: this is a custom component
		<div
