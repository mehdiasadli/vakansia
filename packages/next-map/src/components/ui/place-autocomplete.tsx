...
import {
	...
	CommandItem,
	CommandList,
} from "@vakansia/next-ui/ui/command";
import {
	InputGroup,
	InputGroupAddon,
	InputGroupInput,
} from "@vakansia/next-ui/ui/input-group";
import { Spinner } from "@vakansia/next-ui/ui/spinner";
...
function usePlaceSearch({
	...
	React.useEffect(() => {
		...
		// biome-ignore lint/correctness/useExhaustiveDependencies: need to use
		props,
	]);
